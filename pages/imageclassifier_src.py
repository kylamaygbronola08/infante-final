...
def load_model():
    try:
        model = joblib.load('/content/room.p')
        return model
...
st.write("## 🏠 SORTING ROOMS INTO MESSY OR CLEAN STATES 🏠")
st.write("Upload an image of a room for classification!")

st.sidebar.write("## ⬇️ DOWNLOAD AND ⬆️ UPLOAD")
